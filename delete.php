			    ...
			    $uid4 = intval($user1);
			     ...
			     while ($rowck = $check->fetch()){
					    ...
					    if (strcmp($s,$s2)==0 || strcmp($s,$s3)==0 || strcmp($s,$s4)==0)
					    {
						    ...
						    $del = $conn->prepare("Dquery to DELETE user");
						    //<<bind params here>>
							$del->execute();
							$del->store_result();
			   			    
			    	?>
			    	<h3 align="center"style="font-size:150%; color:#b22222; font-weight:bold; padding-top:4%;">User with UserID <b><?php printf($userid);?></b> was deleted.</h3>
			    	<br></br>
			    	<br></br>
			    	<div align="center"> 
