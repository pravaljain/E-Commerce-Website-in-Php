			...
			try {
			    ...
			    $check= $conn->prepare("query to check user authentiation level");
			     ...
			     while ($rowck = $check->fetch()){
						...
						$query1=$conn->prepare("query to select the user details");
					    //<<bind params here>>
						$query1->execute();
						$query1->store_result();
			    ...
			    if ($rowque=$query->fetch())
			    	...
			    	?>
			    	<h3 align="center" style="font-size:150%; color:#b22222; font-weight:bold; padding-top:4%;">Username Available!</h3>
			    	<div align="center" style="font-size:150%; color:#b22222; font-weight:bold; padding-top:1%;">Please fill out the remaining details.</div>
					<div align="center">
 					<form action="add2.php" method="post"> 
					<br/>
					<table class="table">
					...
					<tr>
						<td>UserID*:</td>
							<td><input class="insearch" type="text" name="userid" maxlength="5" value="<?php printf($uid);?>"></td>
					</tr>
			 	 	<tr>
						<td>Username *:</td>
						<td><input class="insearch" type="text" name="username" value="<?php printf($uname);?>" maxlength="50" required></td>
			 	 	</tr>
					<tr>
						<td>Password *:</td>
						<td><input class="insearch" type="password" name="password" maxlength="50" required value="<?php printf($pswd);?>"></td>
			 	 	</tr>
						<tr>
							<td>Full Name *:</td>
							<td><input class="insearch" type="text" name="fname" maxlength="50" required value="<?php printf($fname);?>"></td>
					</tr>
					<tr>
						<td>Type *:</td>
						<td><input class="insearch" type="text" name="type" maxlength="80" required value="<?php printf($type);?>"></td>
			 	 	</tr>
